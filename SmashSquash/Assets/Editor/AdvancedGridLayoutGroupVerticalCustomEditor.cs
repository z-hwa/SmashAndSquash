...
[CustomEditor(typeof(AdvancedGridLayoutGroupVertical))]
public class AdvancedGridLayoutGroupVerticalCustomEditor : Editor
{
    public override void OnInspectorGUI()
    {
        AdvancedGridLayoutGroupVertical aglg = (this.target as AdvancedGridLayoutGroupVertical);
